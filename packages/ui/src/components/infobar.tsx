  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="infobar"
        className={cn(
          "bg-sidebar text-sidebar-foreground w-(--infobar-width) flex h-full flex-col",
          className,
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "w-(--infobar-width) duration-(--infobar-transition-duration,200ms) relative bg-transparent transition-[width] ease-linear",
      ...
      <div
        ...
        className={cn(
          "w-(--infobar-width) duration-(--infobar-transition-duration,200ms) absolute inset-y-0 z-10 hidden h-svh transition-[left,right,width] ease-linear md:flex",
          side === "left"
