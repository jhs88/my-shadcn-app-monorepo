...
/**
 * This is used in both `entry.server.ts` and `root.tsx` to ensure that the environment variables are set and globally
 * available before the app is started.
 *
 * NOTE: Do _not_ add any environment variables in here that you do not wish to be included in the client.
 *
